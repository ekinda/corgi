...
Merge h5 files using a specified summary statistic.
This is used to merge replicate experiments.

Original code from calico/borzoi
'''
...
def main():
    ...
    parser.add_option('-s', dest='sum_stat',
        default='mean', help='Summary statistic [Default: %default]')
