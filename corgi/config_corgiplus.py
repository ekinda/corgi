...
_MODEL_DIR = _BASE_DIR / 'models' / 'corgi_plus'

# Shared defaults; override in scripts/run_corgiplus_local.py as needed
config_corgiplus = {
    # core data
    'dna_path': str(Path('/project/deeprna/data/dna_onehot.npy')),
    'bed_path': str(Path('/project/deeprna/data/hg38_sequence_folds_tfexcluded34.bed')),
    'tissue_dir': str(Path('/project/deeprna_data/pretraining_data_merged')),
    'mask_path': str(Path('/project/deeprna/data/experiment_mask.npy')),
    'experiments_path': str(Path('/project/deeprna/data/experiments_final.txt')),
    'trans_regulator_expression_path': str(Path('/project/deeprna/data/tf_expression.npy')),
    'gnomad_pickle': str(Path('/project/deeprna/data/gnomad_dictionary.pk')),
